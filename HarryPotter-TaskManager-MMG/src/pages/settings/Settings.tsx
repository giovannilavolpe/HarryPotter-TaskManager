    ...
    return (
        <div className="{th}" style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', flexWrap: 'wrap', marginTop: '100px'}}>
            ...
            <div style={{ width: "100%", display: "flex", justifyContent: "center"}}> 
                <button type="button" onClick={logout} style={{ borderRadius: "10px", width: "150px", height: "50px", fontSize: "20px", backgroundColor: '#a90101', marginBottom: '250px', marginTop: '100px'}}>
                    Log out
                </button>
            </div>
